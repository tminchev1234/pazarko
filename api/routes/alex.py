...
❗ ВАЖНО: В базата продуктите НЕ съдържат думата "gaming" или "RTX" в имената!
Търси по КОНКРЕТНИ гейминг серии и марки:

При "лаптоп за игри" / "gaming laptop" → направи ВСИЧКИ тези търсения:
...
6. Ако < 5 резултата общо → search_products(query="TUF", category="laptops", limit=20)

❌ НЕ търси: "gaming", "RTX", "GeForce", "GPU", "лаптоп за игри"
